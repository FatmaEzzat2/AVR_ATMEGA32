...
#define	 SLA_W_TRANSMITTED_PLUS_ACK_RECEIVED			0x18
#define  SLA_W_TRANSMITTED_PLUS_NACK_RECEIVED			0x20
#define  DATA_TRANSMITTED_PLUS_ACK_RECEIVED				0x28
#define  DATA_TRANSMITTED_PLUS_NACK_RECEIVED			0X30
